...
for model_id in model_names:
    ...
    def obtener_respuesta_modelo(texto):
        prompt = f"Hurrengo testua ironikoa al da? Erantzun Bai edo Ez erabiliz.\n\nTexto: {texto}\n\nRespuesta:"
    ...
    csv_filename = f"respuestasEU_{model_id.split('/')[-1]}.csv"  # Nombre del archivo basado en el nombre del modelo
