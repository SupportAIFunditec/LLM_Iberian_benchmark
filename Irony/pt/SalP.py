...
for model_id in model_names:
    ...
    def obtener_respuesta_modelo(texto):
        prompt = f"O seguinte texto é irónico? Responda com 'Sim' ou 'Não'.\n\nTexto: {texto}\n\nRespuesta:"
    ...
    csv_filename = f"respuestasPT_{model_id.split('/')[-1]}.csv"  # Nombre del archivo basado en el nombre del modelo
