...
for model_id in model_names:
    ...
    def obtener_respuesta_modelo(texto):
        prompt = f"¿El següent text és irònic? Respon amb 'Sí' o 'No'.\n\nTexto: {texto}\n\nRespuesta:"
    ...
    csv_filename = f"respuestasCAT_{model_id.split('/')[-1]}.csv"  # Nombre del archivo basado en el nombre del modelo
